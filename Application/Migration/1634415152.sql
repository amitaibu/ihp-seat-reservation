...
ALTER TABLE seat_categories DROP CONSTRAINT seat_categories_ref_library_id ADD CONSTRAINT seat_categories_ref_library_id FOREIGN KEY (library_id) REFERENCES libraries (id) ON DELETE CASCADE;
